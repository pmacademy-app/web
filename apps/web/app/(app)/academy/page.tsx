 ...
 *
 * Shows the full 9-module curriculum with lesson lists per module,
 * estimated completion time, and links to start each module or open any lesson.
 *
 * Reads exclusively from content/dist/curriculum.json generated by the v2 compiler.
 * Module ordering is determined by the first lesson's `order` field.
 */
...
// This is display metadata only. The content (lessons, order, counts) comes
// entirely from curriculum.json produced by the v2 compiler.
...
export default async function AcademyPage() {
  ...
  // Build ordered module list — determined by the order of the first lesson in each module
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl space-y-8">
      ...
      {/* Module Cards — one per module, with lesson list inside */}
        ...
        {orderedModules.map(([moduleSlug, moduleLessons], idx) => {
          ...
          return (
            ...
            >
              ...
              {/* Expanded: description + lesson list */}
              <div className="px-5 pb-5 space-y-4 border-t border-border/60 pt-4">
                ...
                {firstLesson && (
                  ...
                  >
                    <span>Start Module {moduleNumber} — {meta?.name ?? moduleSlug}</span>
