...
export async function GET(request: Request) {
  ...
  return new NextResponse(
    ...
    <html>
      <head>
        <title>Unsubscribed — PM Academy</title>
        <style>
          body { font-family: -apple-system, sans-serif; background: #fbfaf6; padding: 40px 20px; text-align: center; color: #1a1a1a; }
      ...
      <body>
        <div class="card">
          ...
          <p>You will no longer receive non-essential notification emails from PM Academy.</p>
