 ...
 * Pure functions with zero UI coupling.
 */
...
/** Configurable level thresholds using PRD sequence */
...
export interface LevelInfo {
  level: number
  title: string
  progress: number // percentage 0–100 (rounded)
  progressRatio: number // ratio 0.0–1.0
  xpRemaining: number
 ...
 * Reusable across client & server without hardcoded magic numbers.
 */
...
/**
 * Returns expected XP for a source type.
 * Easily pluggable for future XP sources.
 */
...
/**
 * Calculates incremental quiz XP and bonus for quiz attempts.
 */
 ...
 * Requires minimum active dwell time AND scroll depth percentage >= 80%.
 */
