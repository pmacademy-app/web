...
async function runRemediationTests() {
  ...
  await test('generateQrCodeSvg creates ISO/IEC 18004 compliant QR matrix with rects', () => {
  ...
  await test('evaluateRateLimit throttles repeated contact submissions', async () => {
