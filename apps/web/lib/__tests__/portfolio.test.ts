...
runTest('generatePersonJsonLd generates valid schema.org Person structured data', () => {
  ...
  assert.strictEqual(jsonLd.url, 'https://pmacademy.adityagangwani.me/p/arivera')
...
runTest('formatPortfolioShareUrl returns clean canonical URL', () => {
  const url = formatPortfolioShareUrl('https://pmacademy.adityagangwani.me/', 'arivera')
  assert.strictEqual(url, 'https://pmacademy.adityagangwani.me/p/arivera')
})
