/**
 * Pure Badge Evaluation Utilities (Phase 3 Sprint 4)
 *
 * Provides stateless criteria checking and progress calculations for badges.
 * Zero UI coupling.
 */
...
/**
 * Calculates live progress metrics for a single badge against user stats.
 */
...
/**
 * Evaluates all badge definitions to return keys of badges newly unlocked for user.
 */
