...
**Companion docs:** `../INDEX.md` (documentation entry point — read this first), `../architecture/Architecture.md`, `../development/Rules.md`, `Phases.md`, `../design/Design.md`, `../architecture/content-pipeline.md` and `../architecture/rendering-pipeline.md` (the authoritative technical specs for how lesson content is compiled and rendered — see `../architecture/Architecture.md` §4/§5 for how they relate). Read all before building or changing anything. (`../archive/` contains superseded documents — historical/reference only, not authoritative; see each doc's changelog for what replaced it.)
