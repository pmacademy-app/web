...
| **B8-E** XP uniqueness constraint | ⏸️ **HELD at staging gate — app half shipped** | **High** | **BLOCKED: staging only** | [investigation](B8E_XP_UNIQUENESS_EXECUTION.md) · [original](B8E_XP_UNIQUENESS.md) |
...
documented in [`B8E_PRE_APPROVAL_INVESTIGATION.md`](B8E_XP_UNIQUENESS_EXECUTION.md) §7.
...
[`B8E_PRE_APPROVAL_INVESTIGATION.md`](B8E_XP_UNIQUENESS_EXECUTION.md) — and it found
