...
Google's long history of acquisitions — including YouTube, Android, and DoubleClick, among many others — is widely discussed as an example of varied integration approaches matched, with different degrees of success, to different strategic rationales. Public commentary and industry retrospectives describe YouTube, for instance, being allowed to operate with substantial product and brand independence for an extended period following its acquisition, reflecting a rationale centered on preserving a distinct, valuable consumer brand and its existing user base rather than immediately forcing full technical or brand absorption into Google's existing products, while other acquisitions in Google's history have been integrated far more directly and quickly into core company infrastructure, reflecting a different underlying rationale.
