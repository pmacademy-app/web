...
LinkedIn's "People You May Know" feature, and its broader data science culture around what the company has publicly described as its "Economic Graph," is widely discussed as an example of tight PM/data-science collaboration around model-driven product decisions. Public commentary and engineering blog posts describe extensive experimentation to calibrate what kind of connection recommendation is actually valuable to a user, rather than simply optimizing a model for a generic technical metric like click-through rate in isolation — an illustration of Zone 1 framing (what business and user outcome actually matters) actively shaping Zone 2 model development, rather than the two proceeding independently.

**Assumption flagged:** the specifics of LinkedIn's internal collaboration process between product and data science teams described here are drawn from public engineering commentary and industry reporting, not confirmed internal company statements, and should be treated as illustrative rather than verified fact.
