...
**Netflix** offers a widely cited illustration of the "competing against non-consumption" idea. In various public interviews and shareholder letters over the years, Netflix executives have described the company's real competition not merely as other streaming services, but as any activity competing for a person's leisure time and attention — including sleep, video games, and simply doing nothing. This reframing (competing against the full space of how someone might spend an evening, rather than only against other named subscription services) shapes product and content investment decisions differently than a narrower "beat the other streaming apps" framing would: it points toward maximizing overall engagement and ease of finding something worth watching, rather than exclusively chasing feature parity with a single named rival.

*(Assumption flagged: this reflects publicly reported framing from Netflix leadership commentary over time, rather than a claim about Netflix's current internal strategic language, which this curriculum does not claim certainty about.)*
