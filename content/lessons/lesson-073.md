...
```mermaid
graph TD
    C["Champion<br/>(personally invested advocate inside the org)"] --- E["Economic Buyer<br/>(controls budget, cares about ROI)"]
    E --- T["Technical Evaluator<br/>(IT/security gatekeeper, cares about risk and compliance)"]
    T --- U["End User<br/>(daily user, cares about task fit and usability)"]
    U --- C
```
...
Salesforce's long history selling into large enterprise accounts is widely discussed as an example of a company whose sales methodology explicitly accounts for multiple distinct buying-committee roles, rather than treating enterprise sales as a single-stakeholder relationship. Public commentary on enterprise B2B sales methodology broadly, including approaches associated with and influenced by Salesforce's own sales practices and its widely-adopted CRM platform used to track multi-stakeholder deals, describes deliberately mapping and separately engaging economic buyers, technical evaluators, and internal champions as standard practice in complex enterprise sales cycles, reflecting the same stakeholder-role distinctions this lesson formalizes.

**Assumption flagged:** the specifics of Salesforce's own internal sales methodology and stakeholder engagement practices described here are drawn from public commentary and broader industry sales methodology literature, not confirmed internal company statements, and should be treated as illustrative rather than verified fact.
