...
graph TD
    R[Strategic Judgment Radar] --> A[Strategy Cascade:<br/>Is the underlying bet actually falsifiable?]
    R --> B[Enterprise Adoption Ladder:<br/>Which rung, and what capability blocks the next one?]
    R --> C[Stakeholder Compass:<br/>Which stakeholder role is unaddressed?]
    R --> D[Expansion Wedge:<br/>Does packaging create or block natural growth?]
    R --> E[Moat Durability Matrix:<br/>Is the claimed advantage genuinely durable?]
    R --> F[Integration Continuum:<br/>Does any M&A integration match its rationale?]
    R --> G[Portfolio Health Grid:<br/>Is this bet judged by stage-appropriate evidence?]
    R --> H[Capability Sourcing Matrix:<br/>Should this capability be built, bought, or partnered for?]
