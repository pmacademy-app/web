...
```mermaid
graph TD
    A["Execution, High Automatability<br/>(first-draft specs, research synthesis)<br/>→ Delegate to AI, review outputs"]
    B["Execution, Low Automatability<br/>(specific stakeholder coordination)<br/>→ Still largely manual"]
    C["Judgment, AI-Augmentable<br/>(option generation for a strategic decision)<br/>→ AI assists, human decides"]
    D["Judgment, Irreducibly Human<br/>(trust-building, ethical tradeoffs, ambiguous prioritization)<br/>→ The Judgment Reserve itself"]
```
