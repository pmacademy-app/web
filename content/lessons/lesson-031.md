...
**Amazon** is frequently cited for its historical use of **"two-pizza teams"** — small teams sized so that two pizzas could feed the whole group — and for the closely related concept of **single-threaded ownership**, where one clearly accountable owner (often a PM or a technical leader) drives a specific initiative end-to-end without needing to coordinate every decision through a large committee.

The underlying logic connects directly to this lesson's theory: small, autonomous teams can run tight iteration loops without the coordination overhead that large teams accumulate. A team of eight people can decide, build, and get feedback in days; a team of eighty people attempting the same decision typically cannot, simply because the number of people who must align before any batch of work begins grows the size of that batch by necessity.

*(Assumption flagged: this reflects publicly reported descriptions of Amazon's team-structuring philosophy over the years, not a confirmed, current, complete account of Amazon's internal team sizing or governance today. Team structures inside any large company evolve continuously and vary by organization; the durable lesson is the *principle* — smaller, more autonomous units sustain tighter iteration loops — rather than a specific headcount number.)*
