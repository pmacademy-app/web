...
OpenAI's staged rollout practices for new model capabilities, including publicized safety and reliability evaluation processes before broader release, illustrate evals-as-ongoing-practice and capability/reliability distinction at the model-provider level itself.

**Assumption flagged:** specifics of OpenAI's internal evaluation processes are drawn from public commentary, not confirmed internal statements.
