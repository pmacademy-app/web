...
graph LR
    A[Product = the River Continuous, Ongoing] --- B((Project: v1 Launch))
    A --- C((Project: Redesign))
    A --- D((Project: Infra Migration))
    A --- E((Project: New Market Launch))
    B -.-> A
    C -.-> A
    D -.-> A
    E -.-> A
...
graph TD
    A[Type of Work] --> B[Finite Defined Scope + End Date]
    A --> C[Infinite Ongoing, No End Date]
    B --> D[Managed as a Project<br/>E.g. Ship V2, Migrate Infra]
    C --> E[Managed as a Product E.g. Grow<br/>Retention, Serve Evolving Needs]
    D -.->|feeds into| E
```
