...
**Slack** has been publicly associated, through widely reported early accounts of its growth, with an initial go-to-market approach built almost entirely around product-led, word-of-mouth adoption within individual teams — engineers and small teams tried the product directly, without significant traditional sales or marketing involvement in its earliest period — before the company later built out a more traditional sales-led motion to serve larger enterprise accounts, reflecting a hybrid PLG-plus-sales evolution as the product matured and expanded upmarket.

The underlying principle connects directly to this lesson's Theory: Slack's early motion matched its early product reality — low friction to try, individual/small-team adoption, low initial price point — and the later addition of a sales-led motion for larger accounts reflects the same fit principle applied to a different, more complex segment of its eventual customer base, rather than either motion being universally "correct" independent of the specific product and segment being served.

*(Assumption flagged: this reflects widely reported, publicly discussed accounts of Slack's early growth and go-to-market evolution, not a confirmed, complete, or current account of Slack's specific internal GTM strategy today. Specific strategies and organizational structures evolve continuously at any company; the durable lesson is the underlying principle — GTM motion should match product complexity, price point, and buyer segment, and can evolve as those factors change — rather than a claim about Slack's exact current approach.)*
