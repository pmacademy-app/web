...
**Microsoft's partnership with OpenAI** is directly documented across a series of the companies' own announcements, and its evolution over time makes it a sharper illustration of this lesson's build/buy/partner framing than a static description would. Microsoft's own newsroom confirmed a $1 billion investment and an exclusive Azure computing partnership in July 2019; OpenAI's own site confirmed a further multi-year, multi-billion-dollar extension in January 2023, and CNBC reported the cumulative total reaching roughly $13 billion by April 2023. Throughout this period, Microsoft simultaneously built substantial AI and cloud infrastructure entirely in-house for Azure's core platform, and separately acquired GitHub outright in 2018 — three different sourcing strategies (partner, build, buy) applied to three different capabilities, based on which approach fit each one, not a single default strategy applied uniformly.

The partnership's own trajectory is worth naming directly, since it complicates any tidy account: Forbes reported in April 2026 that Microsoft and OpenAI formally ended their exclusivity and revenue-sharing arrangement, after roughly six years and $13 billion invested. That reversal doesn't undermine the lesson — if anything it reinforces it: a partnership is a sourcing decision suited to a particular moment's constraints (in 2019, OpenAI needed capital and compute Microsoft could provide; Microsoft needed AI capability it didn't yet have in-house), and as both companies' positions and needs evolved, the terms that made sense at the outset stopped fitting, requiring renegotiation rather than remaining fixed indefinitely.

*(Source: Microsoft's own official newsroom (2019), OpenAI's own official site (2023), CNBC's April 2023 reporting on the cumulative investment total, and Forbes' April 2026 reporting on the partnership's restructuring.)*
