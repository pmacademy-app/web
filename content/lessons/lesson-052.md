...
graph LR
    ...
    C --> D["Guide offers a Plan"]
    D --> E["Hero takes action<br/>(Call to Action)"]
    E --> F["Success (or the<br/>Stakes of inaction)"]
```
...
graph TD
    ...
    D["Data + Narrative together:<br/>credible AND memorable"] --> E[Strong, durable persuasion]
```
...
graph LR
    ...
    C --> D[Call to Action<br/>what's being asked]
    D --> E[Stakes<br/>cost of inaction,<br/>shape of success]
```
...
**Airbnb** has been publicly associated, through widely reported accounts of its early product development process, with using storyboarding techniques borrowed from film and animation — reportedly including direct collaboration with a former Pixar storyboard artist — to map out a complete customer journey (sometimes referred to as the "Snow White" storyboard approach, referencing classic animated storytelling structure) before building product features, ensuring the team understood the full emotional and narrative arc of a guest or host's experience, not just an isolated feature list.

The underlying principle connects directly to this lesson's Theory: mapping a customer's actual journey as a story — with a clear problem, a sequence of experiences, and emotional highs and lows — before designing individual features helped ensure the resulting product decisions served a coherent, customer-centered narrative rather than a disconnected collection of isolated capabilities.

*(Assumption flagged: this reflects widely reported, publicly discussed accounts of Airbnb's early storyboarding practices, based on public reporting and interviews with Airbnb's founders, not a confirmed, complete, or current account of Airbnb's specific internal product development process today. Specific practices evolve and vary over time at any company; the durable lesson is the underlying principle — mapping a customer's full narrative journey produces more coherent product decisions than an isolated feature list — rather than a claim to verify every detail of this widely retold story.)*
